...
<body>
<form action="deleteParkingEnter.php" method="post">
<table border="1">
<tr>
	<th>選擇</th>
	<th>流水號</th>	
...
$setSQL = "SELECT * FROM `parking` WHERE `id`='" . $id . "' ORDER BY `no` ASC";
...
while( $row = mysql_fetch_assoc($result) )
{
	...
	echo "<td><a href=\"./updateParking.php?no=" . $row["no"] . "\">更新資料</a></td>"; 
	echo "</tr>";
...
<input type="button" id="createParking" value="新增車位" onClick = "window.location.href='createParking.php'" />
</form>
