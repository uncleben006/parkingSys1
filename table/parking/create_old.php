...
<form action="createEnter.php" method="post">
	<table>
		...
		<tr>
			...
			<td>
			<input type="text" name="QRCode" value = "<?php echo "http://localhost/parkingSys/parkingQR.php?id=" . $id; ?>"  placeholder = ".\xxx.jpg" required />
			</td>
		</tr>		
...
<button type="submit">新增</button>
  ...
  <body onload="load()" >
    <div id="map" style="width: 980px; height: 480px"></div>
