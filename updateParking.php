...
<form action="updateParkingEnter.php" method="post">
<table border="1">
	<tr>
		<td>流水號:</td>
		<td>
	...
	<tr>
		<td>開放租用開始時間</td>
		<td>
			<input type="datetime-local" name="startTime" value="<?php echo $row["startTime"] ?>"/>
		</td>
	</tr>
	...
	<tr>
		<td>開放租用結束時間</td>
		<td>
			<input type="datetime-local" name="endTime" value="<?php echo $row["endTime"] ?>"/>
		</td>
	</tr>			
